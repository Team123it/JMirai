...
### 3.配置插件信息
使用记事本或Notepad++等文本编辑器打开项目根目录下的<a href="../resources/plugin.yml">resources/plugin.yml</a>文件。<br>
...
编写完成保存后请打开<a href="../src/com/example/Demo.java">src/com/example/Demo.java</a>文件,开始你的插件编写之旅吧!(此时可参考JMirai的Javadoc)<br>
